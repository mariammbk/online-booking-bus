                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="BMCI"></asp:ListItem>
                                <asp:ListItem Value="2" Text="BPM"></asp:ListItem>
                                <asp:ListItem Value="3" Text="BNM"></asp:ListItem>
                                <asp:ListItem Value="4" Text="BAMIS"></asp:ListItem>
                                <asp:ListItem Value="5" Text="BMS"></asp:ListItem>
                                <asp:ListItem Value="6" Text="BCM"></asp:ListItem>
                            </asp:DropDownList>
